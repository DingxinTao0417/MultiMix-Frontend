...
- 2026-08-11：已修正时间线时长口径与分割右半段的后端元数据继承；相关单元测试 20 项、类型检查、构建、文档检查及隔离浏览器 E2E 10 项均通过。
- 2026-08-11：生产隔离工程完成分割保存、旧 MP4 失效与重新导出；新成片已进入“下载成片”状态。
- 对应前端提交：`d0888aa`、`86f9698`。
