          ...
          scenes: [{
            ...
            visual_events: [
              ...
              },
              {
                ...
                last_error: "该素材事件缺少已保存且可用的素材绑定。",
                retryable: false,
              },
              {
                event_id: "event-graphic",
                type: "graphic_overlay",
                start_word_id: "pw-1",
                end_word_id: "pw-2",
                purpose: "说明数据变化",
                presentation: "data_card",
                status: "failed",
                required_for_publish: false,
                last_error: "图形动效编译失败，可重试。",
                retryable: true,
              },
            ],
          ...
          metadata: {
            plan: {
              ...
              direction_options: [{
                ...
                duration_seconds: 8,
                visual_system: {
                  style_pack_ref: "evidence@evidence:v1",
                  label: "证据说明",
