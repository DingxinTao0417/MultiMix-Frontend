import type { TimelineTrack, TimelineElement } from "@editor/lib/timeline";
import type { MediaAsset } from "@editor/lib/media/types";
import { isMainTrack } from "@editor/lib/timeline";
import { STICKER_INTRINSIC_SIZE_FALLBACK } from "@editor/constants/sticker-constants";
import { DEFAULT_GRAPHIC_SOURCE_SIZE } from "@editor/lib/graphics";
