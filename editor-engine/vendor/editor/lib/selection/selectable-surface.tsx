...
import { SelectionBox } from "@editor/lib/selection/selection-box";
import { SelectionContext } from "@editor/lib/selection/context";
import { SELECTABLE_ITEM_ATTRIBUTE } from "@editor/lib/selection/constants";
import { resolveElementIntersections } from "@editor/lib/selection/hit-testing";
import {
	applyBoxSelection,
	clearSelection,
	...
	selectRange,
	toggleSelection,
} from "@editor/lib/selection/state";
import type {
	SelectableSurfaceProps,
	SelectionState,
} from "@editor/lib/selection/types";
import { useBoxSelect } from "@editor/lib/selection/hooks/use-box-select";
