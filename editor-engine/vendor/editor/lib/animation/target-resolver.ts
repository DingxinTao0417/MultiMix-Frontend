...
import {
	...
	isEffectParamPath,
} from "@editor/lib/animation/effect-param-channel";
import {
	isGraphicParamPath,
	parseGraphicParamPath,
} from "@editor/lib/animation/graphic-param-channel";
import type { ParamDefinition } from "@editor/lib/params";
import { effectsRegistry, registerDefaultEffects } from "@editor/lib/effects";
import { getGraphicDefinition } from "@editor/lib/graphics";
import type { TimelineElement } from "@editor/lib/timeline";
import { isVisualElement } from "@editor/lib/timeline/element-utils";
import { snapToStep } from "@editor/utils/math";
import {
