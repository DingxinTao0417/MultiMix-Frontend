...
import { shouldMaintainPitch } from "@editor/constants/retime-constants";
import type { MediaAsset } from "@editor/lib/media/types";
import { applyAudioMasteringToBuffer } from "@editor/lib/media/audio-mastering";
import type { AudioCapableElement } from "@editor/lib/timeline/audio-state";
import {
	hasAnimatedVolume,
	resolveEffectiveAudioGain,
} from "@editor/lib/timeline/audio-state";
