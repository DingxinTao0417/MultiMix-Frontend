...
import { VOLUME_DB_MAX, VOLUME_DB_MIN } from "@editor/lib/timeline/audio-constants";
...
import type { AudioElement, VideoElement } from "@editor/lib/timeline";
import { resolveNumberAtTime } from "@editor/lib/animation";
