...
import { isMainTrack } from "@editor/lib/timeline/track-utils";
import type { TrackType, DropTarget, ElementType } from "@editor/lib/timeline";
import type {
	MediaDragData,
	GraphicDragData,
	StickerDragData,
	EffectDragData,
} from "@editor/lib/timeline/drag";
